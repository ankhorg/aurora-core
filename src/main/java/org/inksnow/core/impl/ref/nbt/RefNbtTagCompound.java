...
public final class RefNbtTagCompound extends RefNbtBase {
    ...
    @HandleBy(reference = "Lnet/minecraft/server/v1_14_R1/NBTTagCompound;set(Ljava/lang/String;Lnet/minecraft/server/v1_14_R1/NBTBase;)Lnet/minecraft/server/v1_14_R1/NBTBase;", predicates = "craftbukkit_version:[v1_14_R1,v1_17_R1)")
    ...
    @HandleBy(reference = "Lnet/minecraft/server/v1_12_R1/NBTTagCompound;setByte(Ljava/lang/String;B)V", predicates = "craftbukkit_version:[v1_12_R1,v1_17_R1)")
    ...
    @HandleBy(reference = "Lnet/minecraft/server/v1_12_R1/NBTTagCompound;setShort(Ljava/lang/String;S)V", predicates = "craftbukkit_version:[v1_12_R1,v1_17_R1)")
    ...
    @HandleBy(reference = "Lnet/minecraft/server/v1_12_R1/NBTTagCompound;setInt(Ljava/lang/String;I)V", predicates = "craftbukkit_version:[v1_12_R1,v1_17_R1)")
    ...
    @HandleBy(reference = "Lnet/minecraft/server/v1_12_R1/NBTTagCompound;setFloat(Ljava/lang/String;F)V", predicates = "craftbukkit_version:[v1_12_R1,v1_17_R1)")
    ...
    @HandleBy(reference = "Lnet/minecraft/server/v1_12_R1/NBTTagCompound;setDouble(Ljava/lang/String;D)V", predicates = "craftbukkit_version:[v1_12_R1,v1_17_R1)")
    ...
    @HandleBy(reference = "Lnet/minecraft/server/v1_12_R1/NBTTagCompound;setString(Ljava/lang/String;Ljava/lang/String;)V", predicates = "craftbukkit_version:[v1_12_R1,v1_17_R1)")
    ...
    @HandleBy(reference = "Lnet/minecraft/server/v1_12_R1/NBTTagCompound;setBoolean(Ljava/lang/String;Z)V", predicates = "craftbukkit_version:[v1_12_R1,v1_17_R1)")
    ...
    @HandleBy(reference = "Lnet/minecraft/server/v1_12_R1/NBTTagCompound;d()I", predicates = "craftbukkit_version:[v1_12_R1,v1_15_R1)")
