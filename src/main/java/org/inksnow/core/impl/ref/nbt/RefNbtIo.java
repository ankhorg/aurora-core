...
public final class RefNbtIo {
    @HandleBy(reference = "Lnet/minecraft/nbt/NbtIo;readCompressed(Ljava/nio/file/Path;Lnet/minecraft/nbt/NbtAccounter;)Lnet/minecraft/nbt/CompoundTag;", predicates = "craftbukkit_version:[v1_20_R2,)")
    public static native RefNbtTagCompound readCompressed1(Path path, RefNbtAccounter tagSizeTracker) throws IOException;

    @HandleBy(reference = "Lnet/minecraft/nbt/NbtIo;readCompressed(Ljava/io/File;)Lnet/minecraft/nbt/CompoundTag;", predicates = "craftbukkit_version:[v1_17_R1,v1_20_R2)")
    ...
    @HandleBy(reference = "Lnet/minecraft/nbt/NbtIo;writeCompressed(Lnet/minecraft/nbt/CompoundTag;Ljava/nio/file/Path;)V", predicates = "craftbukkit_version:[v1_20_R2,)")
    public static native void writeCompressed1(RefNbtTagCompound compound, Path path) throws IOException;

    @HandleBy(reference = "Lnet/minecraft/nbt/NbtIo;writeCompressed(Lnet/minecraft/nbt/CompoundTag;Ljava/io/File;)V", predicates = "craftbukkit_version:[v1_17_R1,v1_20_R2)")
