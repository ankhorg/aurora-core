...
@HandleBy(reference = "net/minecraft/server/v1_12_R1/NBTTagFloat", predicates = "craftbukkit_version:[v1_12_R1,v1_17_R1)")
public final class RefNbtTagFloat extends RefNbtNumber {
    ...
    @HandleBy(reference = "Lnet/minecraft/server/v1_15_R1/NBTTagFloat;a(F)Lnet/minecraft/server/v1_15_R1/NBTTagFloat;", predicates = "craftbukkit_version:[v1_15_R1,v1_17_R1)")
