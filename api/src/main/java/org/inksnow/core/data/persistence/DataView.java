...
public interface DataView {
    ...
    /**
     * Gets the {@link ResourcePath key} by path, if available.
     *
     * @param path The path of the value to get
     * @return The key, if available
     */
    default Optional<ResourcePath> getResourceKey(final DataQuery path) {
        ...
        try {
            return Optional.of(ResourcePath.of(value.get()));
    ...
    /**
     * Gets the {@link List} of {@link ResourcePath keys} by path, if available.
     *
     * @param path The path of the value to get
     * @return The list of keys, if available
     */
    default Optional<List<ResourcePath>> getResourceKeyList(final DataQuery path) {
        Objects.requireNonNull(path, "path");
        ...
        final List<ResourcePath> keys = new ArrayList<>();
        for (final String s : strings.get()) {
            try {
                keys.add(ResourcePath.of(s));
