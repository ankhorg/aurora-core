...
@HandleBy(reference = "net/minecraft/server/v1_12_R1/NBTTagByteArray", predicates = "craftbukkit_version:[v1_12_R1,v1_17_R1)")
public final class RefNbtTagByteArray extends RefNbtBase {
    ...
    @HandleBy(reference = "Lnet/minecraft/server/v1_12_R1/NBTTagByteArray;<init>([B)V", predicates = "craftbukkit_version:[v1_12_R1,v1_17_R1)")
    ...
    @HandleBy(reference = "Lnet/minecraft/server/v1_12_R1/NBTTagByteArray;c()[B", predicates = "craftbukkit_version:[v1_12_R1,v1_14_R1)")
