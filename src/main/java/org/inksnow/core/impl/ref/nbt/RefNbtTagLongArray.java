...
@HandleBy(reference = "net/minecraft/server/v1_12_R1/NBTTagLongArray", predicates = "craftbukkit_version:[v1_12_R1,v1_17_R1)")
public final class RefNbtTagLongArray extends RefNbtBase {
    ...
    @HandleBy(reference = "Lnet/minecraft/server/v1_12_R1/NBTTagLongArray;<init>([J)V", predicates = "craftbukkit_version:[v1_12_R1,v1_17_R1)")
