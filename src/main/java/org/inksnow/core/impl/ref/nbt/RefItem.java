...
public final class RefItem {
    ...
    @HandleBy(reference = "Lnet/minecraft/server/v1_14_R1/Item;f(Lnet/minecraft/server/v1_14_R1/ItemStack;)Ljava/lang/String;", predicates = "craftbukkit_version:[v1_14_R1,v1_17_R1)")
    @HandleBy(reference = "Lnet/minecraft/server/v1_13_R1/Item;h(Lnet/minecraft/server/v1_13_R1/ItemStack;)Ljava/lang/String;", predicates = "craftbukkit_version:[v1_13_R1,v1_14_R1)")
    @HandleBy(reference = "Lnet/minecraft/server/v1_12_R1/Item;a(Lnet/minecraft/server/v1_12_R1/ItemStack;)Ljava/lang/String;", predicates = "craftbukkit_version:[v1_12_R1,v1_13_R1)")
