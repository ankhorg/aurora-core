...
@HandleBy(reference = "net/minecraft/server/v1_12_R1/NBTTagEnd", predicates = "craftbukkit_version:[v1_12_R1,v1_17_R1)")
public final class RefNbtTagEnd extends RefNbtBase {
    ...
    @HandleBy(reference = "Lnet/minecraft/server/v1_15_R1/NBTTagEnd;b:Lnet/minecraft/server/v1_15_R1/NBTTagEnd;", predicates = "craftbukkit_version:[v1_15_R1,v1_17_R1)")
